...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME +" (ID INTEGER PRIMARY KEY AUTOINCREMENT,LAYOUT_NAME TEXT,ORIENTATION INTEGER,NAME_POS_Y INTEGER,COMPANY_POS_X INTEGER," +
    ...
    public boolean insertData(String layout_name,String orientatnion,String name_pos_x,String name_pos_y,String company_pos_x,String company_pos_y,String address_pos_x,String address_pos_y,String email_pos_x,String email_pos_y,String phone_pos_x,String phone_pos_y) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COL_2,layout_name);
        contentValues.put(COL_3,orientatnion);
    ...
    public Cursor getAllData() {
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor res = db.rawQuery("select layout_name from "+TABLE_NAME,null);
        return res;
    }

    public boolean updateData(String id,String layout_name,String orientatnion,String name_pos_x,String name_pos_y,String company_pos_x,String company_pos_y,String address_pos_x,String address_pos_y,String email_pos_x,String email_pos_y,String phone_pos_x,String phone_pos_y) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
